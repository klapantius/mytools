...
namespace fixtrax
{
    ...
    internal class FixTrax
    {
        ...
        internal IChange FindVersionOf(IChangeset cs, string vfolder, string vfile)
        {
            ...
            return versioncs.Changes.SingleOrDefault(c => c.Item.ServerItem.EndsWith(vfile));
        }
    ...
    {
        public static void Log(string fmt, params object[] args) { Print(ConsoleColor.DarkGray, fmt, args); }
